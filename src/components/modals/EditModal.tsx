...
import { closeEditModal } from '@/store/app/app.slice';
...
const EditModal = () => {
    ...
    const {editModalOpen} = useEditModal();
    const {user} = useAuth();
  ...
  return (
    <>
    {editModalOpen && currentStage && <div id='modalBackdrop' className='w-screen h-screen absolute top-0 left-0 right-0 bottom-0 m-auto flex items-center justify-center z-50'>
